...
struct __zv_functors
{
  ...
  struct __zip_op_star
  {
    ...
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __tuple_or_pair<
      invoke_result_t<__op_star&, _Types>...>
    operator()(_Types&&... __tuple_elements) const
    ...
    {
      return {_CUDA_VSTD::invoke(__op_star{}, _CUDA_VSTD::forward<_Types>(__tuple_elements))...};
    }
  };
...
#  if _CCCL_STD_VER < 2020 && !defined(_LIBCUDACXX_CUDACC_BELOW_11_3)
...
template <class... _Ranges>
zip_view(_Ranges&&...) -> zip_view<_CUDA_VIEWS::all_t<_Ranges>...>;
...
#  endif // _LIBCUDACXX_HAS_NO_SPACESHIP_OPERATOR
  ...
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  iter_move(const __zip_iterator& __i) noexcept(
    (noexcept(_CUDA_VRANGES::iter_move(declval<const iterator_t<__maybe_const<_Const, _Views>>&>())) && ...)
...
template <class... _Views>
_LIBCUDACXX_INLINE_VAR constexpr bool enable_borrowed_range<zip_view<_Views...>> = (enable_borrowed_range<_Views> && ...);
...
struct __fn
{
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Ranges&&... __rs) const
    noexcept(noexcept(zip_view<all_t<_Ranges>...>(_CUDA_VSTD::forward<_Ranges>(__rs)...)))
      -> decltype(zip_view<all_t<_Ranges>...>(_CUDA_VSTD::forward<_Ranges>(__rs)...))
  {
...
#  if defined(_LIBCUDACXX_COMPILER_GCC) && _CCCL_STD_VER < 2020
...
#  endif // defined(_LIBCUDACXX_COMPILER_GCC) && _CCCL_STD_VER < 2020
