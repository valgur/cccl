...
template <class _Tp, size_t _Np>
_LIBCUDACXX_INLINE_VAR constexpr bool __returnable_element<_Tp, _Np, enable_if_t<move_constructible<tuple_element_t<_Np, _Tp>>>> = true;
...
#  endif // _CCCL_STD_VER < 2020
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES((!__simple_view<_View2>) _LIBCUDACXX_AND(!common_range<_View2>))
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES(range<const _View2> _LIBCUDACXX_AND(!common_range<const _View2>))
