...
_LIBCUDACXX_BEGIN_NAMESPACE_RANGES_ABI
  ...
  public:
    ...
    _LIBCUDACXX_TEMPLATE(class _It)
      _LIBCUDACXX_REQUIRES(__convertible_to_non_slicing<_It, _Iter> _LIBCUDACXX_AND
    ...
    _LIBCUDACXX_TEMPLATE(class _Range)
      _LIBCUDACXX_REQUIRES((!_StoreSize) _LIBCUDACXX_AND
    ...
    _LIBCUDACXX_TEMPLATE(class _Range)
      _LIBCUDACXX_REQUIRES((_Kind == subrange_kind::sized) _LIBCUDACXX_AND
                borrowed_range<_Range> _LIBCUDACXX_AND
                __convertible_to_non_slicing<iterator_t<_Range>, _Iter> _LIBCUDACXX_AND
                convertible_to<sentinel_t<_Range>, _Sent>)
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    ...
    _LIBCUDACXX_TEMPLATE(class _Pair)
      _LIBCUDACXX_REQUIRES(__different_from<_Pair, subrange> _LIBCUDACXX_AND
