...
template<class _Tp>
_LIBCUDACXX_INLINE_VAR constexpr bool enable_borrowed_range<take_view<_Tp>> = enable_borrowed_range<_Tp>;
...
_LIBCUDACXX_INLINE_VAR constexpr bool __is_passthrough_specialization<_CUDA_VRANGES::subrange<_Iter, _Sent, _Kind>> = true;

template <class _Tp>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_iota_specialization = false;

template <class _Np, class _Bound>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_iota_specialization<iota_view<_Np, _Bound>> = true;
