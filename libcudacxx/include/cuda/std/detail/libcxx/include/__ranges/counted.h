...
_LIBCUDACXX_BEGIN_NAMESPACE_CPO(__counted)
  ...
  struct __fn {
...
#ifdef _LIBCUDACXX_COMPILER_NVCC
      -> subrange<_It>
#else // ^^^ _LIBCUDACXX_COMPILER_NVCC ^^^ / vvv !_LIBCUDACXX_COMPILER_NVCC vvv
    ...
    _LIBCUDACXX_TEMPLATE(class _It, class _Diff)
      _LIBCUDACXX_REQUIRES(convertible_to<_Diff, iter_difference_t<_It>> _LIBCUDACXX_AND
