...
private:
  struct __cache_wrapper
  {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __cache_wrapper(
      in_place_t, const _Iter& __iter) noexcept(noexcept(static_cast<decltype(__value_)>(*__iter)))
        : __value_(*__iter)
    {}
  };
...
public:
  ...
  private:
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto&& __update_inner()
    {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr void __satisfy()
    {
...
#  else // ^^^ _CCCL_STD_VER > 2017 ^^^ / vvv _CCCL_STD_VER < 2020 vvv
    ...
    _LIBCUDACXX_REQUIRES(default_initializable<_Outer2>)
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __iterator() noexcept(
      is_nothrow_default_constructible_v<_Outer2>)
    {}
#  endif // _CCCL_STD_VER < 2020

    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __iterator(_Parent& __parent, _Outer __outer)
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr _Inner2 operator->() const
    {
      return *__inner_;
    }
...
#  endif // _CCCL_STD_VER < 2020
  ...
  public:
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __sentinel(_Parent& __parent)
...
#  if _CCCL_STD_VER > 2017
  _LIBCUDACXX_HIDE_FROM_ABI join_view()
    requires default_initializable<_View>
  = default;
#  else // ^^^ _CCCL_STD_VER > 2017 ^^^ / vvv _CCCL_STD_VER < 2020 vvv
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES(default_initializable<_View2>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr join_view() noexcept(
    is_nothrow_default_constructible_v<_View2>)
      : view_interface<join_view<_View>>()
  {}
#  endif // _CCCL_STD_VER < 2020

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit join_view(_View __base)
      : view_interface<join_view<_View>>()
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES(input_range<const _View2> _LIBCUDACXX_AND is_reference_v<range_reference_t<const _View2>>)
