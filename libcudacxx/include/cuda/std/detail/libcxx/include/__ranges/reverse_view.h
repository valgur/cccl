...
_LIBCUDACXX_INLINE_VAR constexpr bool __is_sized_reverse_subrange<_CUDA_VRANGES::subrange<reverse_iterator<_Iter>, reverse_iterator<_Iter>, _CUDA_VRANGES::subrange_kind::sized>> = true;

template<class _Tp>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_unsized_reverse_subrange = false;

template<class _Iter, subrange_kind _Kind>
_LIBCUDACXX_INLINE_VAR constexpr bool __is_unsized_reverse_subrange<_CUDA_VRANGES::subrange<reverse_iterator<_Iter>, reverse_iterator<_Iter>, _Kind>> = _Kind == _CUDA_VRANGES::subrange_kind::unsized;
...
struct __fn : __range_adaptor_closure<__fn> {
  ...
  _LIBCUDACXX_TEMPLATE(class _Range)
    _LIBCUDACXX_REQUIRES((!__is_reverse_view<remove_cvref_t<_Range>>) _LIBCUDACXX_AND
