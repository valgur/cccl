...
struct __range_adaptor_closure {
    _LIBCUDACXX_TEMPLATE(class _View, class _Closure)
      _LIBCUDACXX_REQUIRES(_CUDA_VRANGES::viewable_range<_View> _LIBCUDACXX_AND _RangeAdaptorClosure<_Closure> _LIBCUDACXX_AND
  ...
  _LIBCUDACXX_NODISCARD_ATTRIBUTE
    ...
    _LIBCUDACXX_TEMPLATE(class _Closure, class _OtherClosure)
      _LIBCUDACXX_REQUIRES(_RangeAdaptorClosure<_Closure> _LIBCUDACXX_AND _RangeAdaptorClosure<_OtherClosure> _LIBCUDACXX_AND
                same_as<_Tp, remove_cvref_t<_Closure>> _LIBCUDACXX_AND
