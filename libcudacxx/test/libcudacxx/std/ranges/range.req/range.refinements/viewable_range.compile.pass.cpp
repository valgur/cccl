...
struct T2 : test_range<cpp20_input_iterator>, cuda::std::ranges::view_base {
  T2(T2 const&) = default;
};
...
struct T3 : test_range<cpp20_input_iterator>, cuda::std::ranges::view_base {
  T3(T3 const&) = default;
};
...
struct T4 : test_range<cpp20_input_iterator>, cuda::std::ranges::view_base {
  T4(T4 const&) = delete;
