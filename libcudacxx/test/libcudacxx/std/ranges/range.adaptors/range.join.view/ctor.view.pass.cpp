...
__host__ __device__ constexpr bool test() {
  ...
  {
    // Test explicitness.
    static_assert( cuda::std::is_constructible_v<cuda::std::ranges::join_view<ParentView<ChildView>>, ParentView<ChildView>>);
    static_assert(!cuda::std::is_convertible_v<cuda::std::ranges::join_view<ParentView<ChildView>>, ParentView<ChildView>>);
  }
