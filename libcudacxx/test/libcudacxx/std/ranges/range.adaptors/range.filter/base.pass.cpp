...
struct Range : cuda::std::ranges::view_base {
  ...
  __host__ __device__ constexpr Range(Range const& other) : begin_(other.begin_), end_(other.end_), wasCopyInitialized(true) { }
  __host__ __device__ constexpr Range(Range&& other) : begin_(other.begin_), end_(other.end_), wasMoveInitialized(true) { }
