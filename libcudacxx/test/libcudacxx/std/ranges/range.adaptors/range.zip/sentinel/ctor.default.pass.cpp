...
struct PODSentinel {
  ...
  __host__ __device__ friend constexpr bool operator==(int*, const PODSentinel& s) { return s.b; }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool operator==(const PODSentinel& s, int*) { return s.b; }
  __host__ __device__ friend constexpr bool operator!=(int*, const PODSentinel& s) { return !s.b; }
  __host__ __device__ friend constexpr bool operator!=(const PODSentinel& s, int*) { return !s.b; }
#endif
};
