...
struct ThrowOnIncrementIterator {
  ...
  __host__ __device__ explicit ThrowOnIncrementIterator(int* it) : it_(it) {}
  ...
  __host__ __device__ void operator++(int) { ++it_; }

  __host__ __device__ int& operator*() const { return *it_; }
...
struct ThrowOnIncrementView : IntBufferView {
  __host__ __device__ ThrowOnIncrementIterator begin() const { return ThrowOnIncrementIterator{buffer_}; }
  __host__ __device__ ThrowOnIncrementIterator end() const { return ThrowOnIncrementIterator{buffer_ + size_}; }
};
