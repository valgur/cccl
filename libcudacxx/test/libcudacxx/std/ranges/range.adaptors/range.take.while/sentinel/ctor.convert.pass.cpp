...
struct Sent {
  ...
  __host__ __device__ friend constexpr bool operator==(int* iter, const Sent& s) { return s.i > *iter; }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool operator==(const Sent& s, int* iter) { return s.i > *iter; }
  __host__ __device__ friend constexpr bool operator!=(int* iter, const Sent& s) { return s.i <= *iter; }
  __host__ __device__ friend constexpr bool operator!=(const Sent& s, int* iter) { return s.i <= *iter; }
#endif
};
...
struct ConstSent {
  ...
  __host__ __device__ friend constexpr bool operator==(int* iter, const ConstSent& s) { return s.i > *iter; }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool operator==(const ConstSent& s, int* iter) { return s.i > *iter; }
  __host__ __device__ friend constexpr bool operator!=(int* iter, const ConstSent& s) { return s.i <= *iter; }
  __host__ __device__ friend constexpr bool operator!=(const ConstSent& s, int* iter) { return s.i <= *iter; }
#endif
};
...
struct NonConvertConstSent {
  ...
  __host__ __device__ friend constexpr bool operator==(int* iter, const NonConvertConstSent& s) { return s.i > *iter; }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool operator==(const NonConvertConstSent& s, int* iter) { return s.i > *iter; }
  __host__ __device__ friend constexpr bool operator!=(int* iter, const NonConvertConstSent& s) { return s.i <= *iter; }
  __host__ __device__ friend constexpr bool operator!=(const NonConvertConstSent& s, int* iter) { return s.i <= *iter; }
#endif
};
...
// Test Constraint
static_assert(cuda::std::is_constructible_v<cuda::std::ranges::sentinel_t<const cuda::std::ranges::take_while_view<Range, Pred>>,
                                      cuda::std::ranges::sentinel_t<cuda::std::ranges::take_while_view<Range, Pred>>>);

// !Const
static_assert(!cuda::std::is_constructible_v<cuda::std::ranges::sentinel_t<cuda::std::ranges::take_while_view<Range, Pred>>,
...
struct MoveOnlyConvert {
  ...
  __host__ __device__ constexpr MoveOnlyConvert(Sent&& s) : i(s.i) { s.i = 0; }
  __host__ __device__ constexpr friend bool operator==(const MoveOnlyConvert& s, int* iter) { return s.i > *iter; }
#if TEST_STD_VER < 2020
  __host__ __device__ constexpr friend bool operator==(int* iter, const MoveOnlyConvert& s) { return s.i > *iter; }
  __host__ __device__ constexpr friend bool operator!=(const MoveOnlyConvert& s, int* iter) { return s.i <= *iter; }
  __host__ __device__ constexpr friend bool operator!=(int* iter, const MoveOnlyConvert& s) { return s.i <= *iter; }
#endif
};
