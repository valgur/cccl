...
using ForwardSubrange = cuda::std::ranges::subrange<ForwardIter, ForwardIter, cuda::std::ranges::subrange_kind::unsized>;
...
struct MoveOnlyForwardIter {
    ...
    __host__ __device__ constexpr MoveOnlyForwardIter(int *ptr) : base(ptr) { }
    ...
    __host__ __device__ friend constexpr bool operator==(const self& lhs, int* rhs) { return lhs.base == rhs; }
#if TEST_STD_VER < 2020            \
 || defined(TEST_COMPILER_CLANG) \
 || defined(TEST_COMPILER_NVRTC) \
 || defined(TEST_COMPILER_MSVC)
    __host__ __device__ friend constexpr bool operator==(int* rhs, const self& lhs) { return lhs.base == rhs; }
    __host__ __device__ friend constexpr bool operator!=(const self& lhs, int* rhs) { return lhs.base != rhs; }
    __host__ __device__ friend constexpr bool operator!=(int* rhs, const self& lhs) { return lhs.base != rhs; }
#endif
    ...
    __host__ __device__ constexpr operator pointer() const { return base; }
};
...
struct SizedSentinelForwardIter {
    ...
    __host__ __device__ friend constexpr bool operator==(const self& lhs, const self& rhs) { return lhs.base_ == rhs.base_; }
#if TEST_STD_VER < 2020
    __host__ __device__ friend constexpr bool operator!=(const self& lhs, const self& rhs) { return lhs.base_ != rhs.base_; }
#endif
    ...
    __host__ __device__ friend constexpr difference_type operator-(SizedSentinelForwardIter const& a,
...
struct ConvertibleForwardIter {
    ...
    __host__ __device__ constexpr explicit ConvertibleForwardIter(int *ptr) : base_(ptr) { }
    ...
    __host__ __device__ constexpr operator pointer() const { return base_; }
...
using ConvertibleForwardSubrange = cuda::std::ranges::subrange<ConvertibleForwardIter, int*,
...
struct ConditionallyConvertibleBase {
    ...
    __host__ __device__ constexpr explicit ConditionallyConvertibleBase(int *ptr) : base_(ptr) {}

    __host__ __device__ constexpr int *base() const { return base_; }

#if TEST_STD_VER < 2020
    __host__ __device__ friend bool operator==(const self& lhs, const self& rhs) { return lhs.base_ == rhs.base_; }
    __host__ __device__ friend bool operator!=(const self& lhs, const self& rhs) { return lhs.base_ != rhs.base_; }
#else
...
using SizedSentinelForwardSubrange = cuda::std::ranges::subrange<ConditionallyConvertibleIter,
...
using ConvertibleSizedSentinelForwardSubrange = cuda::std::ranges::subrange<ConvertibleSizedSentinelForwardIter, int*,
                                                                      cuda::std::ranges::subrange_kind::sized>;

struct ForwardBorrowedRange {
  __host__ __device__ constexpr ForwardIter begin() const { return ForwardIter(globalBuff); }
  __host__ __device__ constexpr ForwardIter end() const { return ForwardIter(globalBuff + 8); }
};
...
struct ConvertibleForwardBorrowedRange {
  __host__ __device__ constexpr ConvertibleForwardIter begin() const { return ConvertibleForwardIter(globalBuff); }
...
struct ForwardBorrowedRangeDifferentSentinel {
  struct sentinel {
    int *value;
    __host__ __device__ friend bool operator==(sentinel s, ForwardIter i) { return s.value == base(i); }
#if TEST_STD_VER < 2020
    __host__ __device__ friend bool operator==(ForwardIter i, sentinel s) { return s.value == base(i); }
    __host__ __device__ friend bool operator!=(sentinel s, ForwardIter i) { return s.value != base(i); }
    __host__ __device__ friend bool operator!=(ForwardIter i, sentinel s) { return s.value != base(i); }
#endif
  };
  ...
  __host__ __device__ constexpr ForwardIter begin() const { return ForwardIter(globalBuff); }
  __host__ __device__ constexpr sentinel end() const { return sentinel{globalBuff + 8}; }
};
...
using DifferentSentinelSubrange = cuda::std::ranges::subrange<ForwardIter,
...
struct DifferentSentinelWithSizeMember {
  ...
  __host__ __device__ constexpr ForwardIter begin() const { return ForwardIter(globalBuff); }
  __host__ __device__ constexpr sentinel end() const { return sentinel{globalBuff + 8}; }
  __host__ __device__ constexpr size_t size() const { return 8; }
};
...
using DifferentSentinelWithSizeMemberSubrange = cuda::std::ranges::subrange<ForwardIter,
