...
struct SomeIntComparable {
  ...
  SomeInt value_;
  __host__ __device__ constexpr SomeIntComparable() : value_(SomeInt(10)) {}
  ...
  __host__ __device__ constexpr SomeIntComparable& operator++() { ++value_; return *this; }
  __host__ __device__ constexpr SomeIntComparable  operator++(int) { auto tmp = *this; ++value_; return tmp; }
  __host__ __device__ constexpr SomeIntComparable  operator--() { --value_; return *this; }
};
