...
struct SomeInt {
  ...
  int value_;
  __host__ __device__ constexpr explicit SomeInt(int value = 0) : value_(value) {}
  ...
  __host__ __device__ constexpr SomeInt& operator++() { ++value_; return *this; }
  __host__ __device__ constexpr SomeInt  operator++(int) { auto tmp = *this; ++value_; return tmp; }
  __host__ __device__ constexpr SomeInt& operator--() { --value_; return *this; }
  __host__ __device__ constexpr SomeInt  operator--(int) { auto tmp = *this; --value_; return tmp; }
};
...
struct IntComparableWith {
  ...
  T value_;
  __host__ __device__ constexpr explicit IntComparableWith(T value = T()) : value_(value) {}
  ...
  __host__ __device__ constexpr IntComparableWith& operator++() { ++value_; return *this; }
  __host__ __device__ constexpr IntComparableWith  operator++(int) { auto tmp = *this; ++value_; return tmp; }
  __host__ __device__ constexpr IntComparableWith  operator--() { --value_; return *this; }
};
template <class T>
...
struct IntSentinelWith {
  ...
  T value_;
  __host__ __device__ constexpr explicit IntSentinelWith(T value = T()) : value_(value) {}
  ...
  __host__ __device__ constexpr IntSentinelWith& operator++() { ++value_; return *this; }
  __host__ __device__ constexpr IntSentinelWith  operator++(int) { auto tmp = *this; ++value_; return tmp; }
  __host__ __device__ constexpr IntSentinelWith  operator--() { --value_; return *this; }
};
template <class T>
...
struct NotIncrementable {
  ...
  int value_;
  __host__ __device__ constexpr explicit NotIncrementable(int value = 0) : value_(value) {}
  ...
  __host__ __device__ constexpr NotIncrementable& operator++()    { ++value_; return *this; }
...
struct NotDecrementable {
  ...
  int value_;
  __host__ __device__ constexpr explicit NotDecrementable(int value = 0) : value_(value) {}
  ...
  __host__ __device__ constexpr NotDecrementable& operator++()    { ++value_; return *this; }
  __host__ __device__ constexpr void              operator++(int) { ++value_;               }
};
...
struct Int42 {
  ...
  int value_;
  __host__ __device__ constexpr explicit Int42(int value) : value_(value) {}
  template<CtorKind CK2 = CK, cuda::std::enable_if_t<CK2 == DefaultTo42, int> = 0>
  __host__ __device__ constexpr explicit Int42() : value_(42) {}
  ...
  __host__ __device__ constexpr Int42& operator++()    { ++value_; return *this; }
  __host__ __device__ constexpr void   operator++(int) { ++value_;               }
};
