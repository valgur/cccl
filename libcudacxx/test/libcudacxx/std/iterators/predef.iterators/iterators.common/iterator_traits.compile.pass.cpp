...
__host__ __device__ void test() {
  ...
  {
    static_assert(cuda::std::input_iterator<cuda::std::common_iterator<cpp17_input_iterator<int*>, sentinel_type<int*>>>);
    static_assert(cuda::std::forward_iterator<cuda::std::common_iterator<forward_iterator<int*>, sentinel_type<int*>>>);
    static_assert(cuda::std::forward_iterator<cuda::std::common_iterator<random_access_iterator<int*>, sentinel_type<int*>>>);
    static_assert(cuda::std::forward_iterator<cuda::std::common_iterator<contiguous_iterator<int*>, sentinel_type<int*>>>);
    // Even these are only forward.
    static_assert(!cuda::std::bidirectional_iterator<cuda::std::common_iterator<random_access_iterator<int*>, sentinel_type<int*>>>);
    static_assert(!cuda::std::bidirectional_iterator<cuda::std::common_iterator<contiguous_iterator<int*>, sentinel_type<int*>>>);
