...
__host__ __device__ TEST_CONSTEXPR_CXX20 bool test() {
...

  {
    ...
    auto commonIter2 = cuda::std::common_iterator<decltype(iter1), sentinel_type<int*>>(cpp17_input_iterator<int*>(buffer + 1));
  ...
  }
  {
    ...
    auto commonIter1 = cuda::std::common_iterator<decltype(iter1), sentinel_type<int*>>(iter1);
    auto commonIter2 = cuda::std::common_iterator<decltype(iter1), sentinel_type<int*>>(forward_iterator<int*>(buffer + 1));
  ...
  }
  {
    ...
    auto commonSent2 = cuda::std::common_iterator<decltype(iter1), sentinel_type<int*>>(sentinel_type<int*>{buffer + 7});
  ...
  }
  {
    ...
    auto commonSent2 = cuda::std::common_iterator<decltype(iter2), sentinel_type<int*>>(sentinel_type<int*>{buffer + 7});
...
#ifndef TEST_HAS_NO_EXCEPTIONS
  {
    ...
    auto commonIter1 = cuda::std::common_iterator<decltype(iter1), sentinel_type<int*>>(iter1);
    auto commonSent2 = cuda::std::common_iterator<decltype(iter1),
